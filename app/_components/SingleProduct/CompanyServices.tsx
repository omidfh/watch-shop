...
export default function CompanyServices() {
  return (
    <div className="grid lg:grid-rows-2 lg:grid-cols-3 md:grid-cols-2 md:grid-rows-3 grid-cols-1 grid-rows-6 gap-4">
      {/* //* FIRST ROW */}
      {/* <div className="grid lg:grid-rows-2 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4 "> */}
      <CompanyServiceItem
